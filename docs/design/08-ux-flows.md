...
### 10.1 Кто он
Спокойный компетентный **напарник-прораб**: **жёлтая каска** (как на реальной стройке) +
фирменные **пышные** усы Дали, **всегда закрученные вверх** — это подпись, она не
меняется ни в одном состоянии. Бренд-акцент интерфейса — зелёный; каска жёлтая (реализм),
и вместе они не конфликтуют (прораб в жёлтой каске пользуется зелёным приложением). Эмоцию несут глаза/брови/наклон головы и реквизит (рулетка,
