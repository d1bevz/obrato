...
| 6. Улучшить нормы позже | После фактов можно сузить будущие диапазоны | «Что можно пересчитать, а что было rough?» | состояние ProjectDetail после фактов, отдельного экрана MVP нет | Reconciliation on-demand |
